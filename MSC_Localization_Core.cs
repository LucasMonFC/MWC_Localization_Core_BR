...
namespace MSC_Localization_Core
{
    public class MSC_Localization_Core : Mod
    {
        ...
        private void StartReloadTranslations()
        {
            ...
            reloadHandlerObject = new GameObject("MSC_ReloadTranslationsHandler");
        ...
        {
            public void Initialize(MSC_Localization_Core owner)
            {
        ...
        private IEnumerator ReloadTranslationsRoutine()
        {
            ...
            ProgressBarMode progressMode = BeginProgress("MSC Localization Core", 7, "Recarregando traduções...");
            try
            {
                ...
                UpdateProgress(progressMode, 4, "Reinicializando superfícies...");
                yield return null;
                ...
                UpdateProgress(progressMode, 7, "Reload concluído.");
    ...
    {
        private const string ObjectName = "MSC_Localization_Core_ProgressCloser";
