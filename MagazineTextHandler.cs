...
namespace MWC_Localization_Core
{
    ...
    public class MagazineTextHandler
    {
        ...
        public bool HandleMagazineText(TextMesh textMesh)
        {
            ...
            logger.LogInfo($"[Magazine] Processing text: '{textMesh.text}' (special: {needsSpecialProcessing})");
            ...
            {
                logger.LogInfo($"[Magazine] Standard translation found for '{key}'");
            ...
            logger.LogWarning($"[Magazine] No translation found for: '{textMesh.text}' (key: '{key}')");
            translatedMagazineTexts.Add(textMesh);
        ...
        {
            logger.LogInfo($"[Magazine] Translating comma-separated words: '{textMesh.text}'");
        ...
        {
            logger.LogInfo($"[Magazine] Translating price/phone line: '{textMesh.text}'");
            try
            {
